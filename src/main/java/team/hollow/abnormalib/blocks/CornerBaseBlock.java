...
public class CornerBaseBlock extends Block implements Waterloggable {
	...
	public CornerBaseBlock(BlockState blockState_1, Settings block$Settings_1) {
	...
	static {
		...
		SOUTH_SIDING_SHAPE = SidingBaseBlock.SINGLE_SHAPE_SOUTH;
		WEST_SIDING_SHAPE = SidingBaseBlock.SINGLE_SHAPE_WEST;
