...
public interface TagFactory<T> {
	...
	TagFactory<Biome> BIOME = of(Registry.BIOME_KEY, "tags/worldgen/biomes");
	TagFactory<DimensionType> DIMENSION_TYPE = of(Registry.DIMENSION_TYPE_KEY, "tags/dimension_types");
	TagFactory<ChunkGeneratorSettings> NOISE_SETTINGS = of(Registry.CHUNK_GENERATOR_SETTINGS_KEY, "tags/worldgen/noise_settings");
	TagFactory<DimensionOptions> DIMENSIONS = of(Registry.DIMENSION_KEY, "tags/dimensions");
