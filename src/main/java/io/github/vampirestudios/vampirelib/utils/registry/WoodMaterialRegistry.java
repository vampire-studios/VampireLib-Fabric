...
public abstract class WoodMaterialRegistry implements StringRepresentable {
	public static final Registry<WoodMaterial> WOOD_MATERIALS = FabricRegistryBuilder
			.createSimple(WoodMaterial.class, VampireLib.INSTANCE.identifier("wood_material_registry"))
			.buildAndRegister();
