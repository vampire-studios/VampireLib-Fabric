package io.github.vampirestudios.vampirelib.utils.modifications;
	...
	protected void apply(Map<ResourceLocation, JsonElement> map, ResourceManager resourceManager, ProfilerFiller profilerFiller) {
		...
		for (Map.Entry<ResourceLocation, JsonElement> entry : map.entrySet()) {
			...
			try {
				...
				VampireLib.INSTANCE.getLogger().error("Parsing error loading " + type + " Modifier Group: {}", resourcelocation, jsonparseexception);
			}
		}
		VampireLib.INSTANCE.getLogger().info(type + " Modification Manager has loaded {} modifier groups", groupsLoaded);
	}
