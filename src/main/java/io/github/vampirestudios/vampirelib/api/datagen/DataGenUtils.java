...
public class DataGenUtils {
    ...
    public static void generateSapling(String path, Block block, Block pottedBlock, BlockModelGenerators generators) {
        ...
        ResourceLocation pottedSapling = BlockModelGenerators.TintState.NOT_TINTED.getCrossPot().create(pottedBlock,
            pottedSaplingMapping, generators.modelOutput);
    ...
    public static void generateSimpleCubeModels(BlockModelGenerators blockStateModelGenerator, ResourceLocation resourceLocation, Block block) {
        ...
        ResourceLocation brimstoneCoalOreResourceLocation = ModelTemplates.CUBE_ALL.create(block, brimstoneCoalOreTextureMapping,
    ...
    public static void generateConnectedCubeModels(BlockModelGenerators blockStateModelGenerator, ResourceLocation resourceLocation,
                                                   ResourceLocation resourceLocation2, Block block, Property<Boolean> property) {
        ResourceLocation notConnectedResourceLocation = ModelTemplates.CUBE_ALL.create(block, TextureMapping.cube(resourceLocation),
            blockStateModelGenerator.modelOutput);
        ResourceLocation connectedResourceLocation = ModelTemplates.CUBE_ALL.create(block, TextureMapping.cube(resourceLocation2),
            blockStateModelGenerator.modelOutput);
    ...
    public static void generateConnectedTopBottomSideModels(BlockModelGenerators blockStateModelGenerator, ResourceLocation notConnectedTexture,
        ...
        ResourceLocation notConnectedResourceLocation = ModelTemplates.CUBE_ALL.create(block, TextureMapping.cube(notConnectedTexture),
            blockStateModelGenerator.modelOutput);
        ResourceLocation connectedResourceLocation = ModelTemplates.CUBE_BOTTOM_TOP.createWithSuffix(block, "_connected", connectedTextureMapping,
            blockStateModelGenerator.modelOutput);
        blockStateModelGenerator.blockStateOutput.accept(createConnectedBlock(block, property, connectedResourceLocation, notConnectedResourceLocation));
        blockStateModelGenerator.delegateItemModel(block, notConnectedResourceLocation);
    }

    public static void generateConnectedEndSideModels(BlockModelGenerators blockStateModelGenerator, ResourceLocation notConnectedTexture,
        ...
        ResourceLocation notConnectedResourceLocation = ModelTemplates.CUBE_ALL.create(block, TextureMapping.cube(notConnectedTexture),
            blockStateModelGenerator.modelOutput);
        ResourceLocation connectedResourceLocation = ModelTemplates.CUBE_COLUMN.create(block, connectedTextureMapping,
            blockStateModelGenerator.modelOutput);
        blockStateModelGenerator.blockStateOutput.accept(createConnectedBlock(block, property, connectedResourceLocation, notConnectedResourceLocation));
        blockStateModelGenerator.delegateItemModel(block, notConnectedResourceLocation);
    }
    ...
    public static void generateSimpleColumnModels(BlockModelGenerators blockStateModelGenerator, ResourceLocation side, ResourceLocation end, Block block) {
        ...
        blockStateModelGenerator.delegateItemModel(block, ModelLocationUtils
    ...
    public static void createCarpet(BlockModelGenerators blockStateModelGenerator, Block block, ResourceLocation texture) {
        blockStateModelGenerator.createTrivialBlock(block, TexturedModel.CARPET.updateTexture(textureMapping -> textureMapping.put(TextureSlot.WOOL, texture)));
    ...
    public static void createCaveVines(Block vines, Block plant, BlockModelGenerators blockStateModelGenerator) {
        ResourceLocation resourceLocation = blockStateModelGenerator.createSuffixedVariant(vines, "", ModelTemplates.CROSS, TextureMapping::cross);
        ResourceLocation resourceLocation2 = blockStateModelGenerator.createSuffixedVariant(vines, "_lit", ModelTemplates.CROSS, TextureMapping::cross);
        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.multiVariant(vines).with(createBooleanModelDispatch(BlockStateProperties.BERRIES, resourceLocation2, resourceLocation)));
        ResourceLocation resourceLocation3 = blockStateModelGenerator.createSuffixedVariant(plant, "", ModelTemplates.CROSS, TextureMapping::cross);
        ResourceLocation resourceLocation4 = blockStateModelGenerator.createSuffixedVariant(plant, "_lit", ModelTemplates.CROSS, TextureMapping::cross);
        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.multiVariant(plant).with(createBooleanModelDispatch(BlockStateProperties.BERRIES, resourceLocation4, resourceLocation3)));
    }
