...
/**
 * Holds data for an individual sound's JSON entry to be generated and added for some {@link net.minecraft.sounds.SoundEvent}.
 */
public record SoundEntry(ResourceLocation name, float volume, float pitch, int weight, boolean stream, int attenuationDistance, boolean preload, boolean event) {
